...
print_pdf.addEventListener("click", function () {
    ...
    .lang h3, .interest h3 {margin-bottom: .2rem}
    ...
    .interest li {margin-top : -5px} .right-side {height : 98%} .level-bar {height: 1.8vh; border-radius: 4px; font-size: 14px;} .formations h3 {margin : 10px}
    .skills_progressbar img, .lang img, .interest img{width: 20px; height: 20px; margin-right: 5px}
